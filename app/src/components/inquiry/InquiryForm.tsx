...
export function InquiryForm({
  ...
  onSuccess,
  onCancel,
  className = "mt-4 flex flex-col gap-my-40 px-my-12 lg:px-my-20",
  rootClassName,
}: InquiryFormProps) {
  ...
  return (
    <div className={cn("flex min-h-0 flex-1 flex-col overflow-hidden", rootClassName)}>
      ...
      <div className="mx-0 mt-0 w-full shrink-0 bg-white px-my-12 lg:px-my-20 pt-my-20 pb-my-20">
        <div className="flex items-center justify-end gap-my-12">
          <Button
            type="button"
            variant="outline"
            size="sm"
            className="px-my-12 lg:px-my-20"
