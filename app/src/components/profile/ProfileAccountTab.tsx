...
const LINKED_PROVIDERS = [
  { id: "google", label: "Google", icon: ICONS.googleBrand, connected: true },
  { id: "line", label: "LINE", icon: ICONS.lineBrand, connected: false },
] as const;
        ...
        >
          ...
          <div className="flex flex-col gap-3">
            ...
            <ul className="flex flex-col gap-2">
              {LINKED_PROVIDERS.map(({ id, label, icon, connected }) => (
                <li
                  key={id}
