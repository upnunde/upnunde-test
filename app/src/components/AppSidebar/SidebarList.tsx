...
const DEFAULT_ITEM_CLASS =
  "flex w-full cursor-pointer items-center gap-3 rounded-md px-3 py-2 text-body3_500 transition-colors outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2";
const DEFAULT_ACTIVE_CLASS = "text-primary";
const DEFAULT_INACTIVE_CLASS = "text-foreground-muted hover:bg-muted";
