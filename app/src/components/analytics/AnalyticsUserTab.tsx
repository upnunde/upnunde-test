  ...
  return (
    <div className="flex flex-col items-start justify-start gap-my-12 lg:gap-my-20 self-stretch px-0">
          ...
          {userDummy.primary.map((stat, i, arr) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "flex min-w-[140px] flex-1 flex-col items-center gap-my-4 border-b border-border-10 px-my-16 lg:px-my-20 py-my-40 text-left outline-none transition-colors",
      ...
      <AnalyticsPanel>
        ...
        <div className="mb-2 mt-2 inline-flex flex-col items-start justify-start gap-my-8 self-stretch px-my-16 lg:px-my-20 pb-0 pt-0">
          <SegmentedTextTabs
        ...
        <div className="flex flex-col items-start justify-start gap-my-12 self-stretch rounded-lg pb-my-20 pt-my-12">
          ...
          <div className="inline-flex items-start justify-between self-stretch px-my-16 lg:px-my-20">
      ...
      <div className="inline-flex w-full flex-col items-stretch gap-my-12 lg:gap-my-20 lg:inline-flex lg:flex-row">
        <div className="flex min-w-0 flex-1 flex-col gap-my-12 lg:gap-my-20">
          <AnalyticsPanel>
            ...
            <div className="flex flex-col gap-my-12 px-my-16 lg:px-my-20 pt-my-12">
  ...
  return (
    <AnalyticsPanel>
      ...
      <div className="flex flex-col gap-my-12 lg:gap-my-20 pb-my-20 pt-my-12">
        ...
        <div className="flex flex-col gap-my-8 px-my-16 lg:px-my-20">
          {legend.map((row, i) => (
            <LegendRow
