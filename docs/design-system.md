...
- **3단 브레이크포인트**: 모바일(&lt;768) · 태블릿(768–1023) · 데스크톱(≥1024). 상세·훅: [`docs/mobile-layout.md`](mobile-layout.md) · `.cursor/rules/layout-breakpoints.mdc`
- **Mobile First**: 기본 레이아웃은 모바일 기준, 확장은 `md:`·`lg:` 접두사. 레이아웃 구간에 `sm:`·임의 `min-[…]` 금지.
