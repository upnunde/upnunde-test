...
#### 페이지·카드 본문 인셋 (공통)
- **가로 인셋**: 모바일 **`my-16`(16px)** · lg+ **`my-20`(20px)** → Tailwind **`px-my-16 lg:px-my-20`**
...
- 페이지 가로 인셋·스택 gap에 **`px-my-20`·`gap-my-20` 단독 사용 금지** — `PAGE_GUTTER_X_CLASS` / `PAGE_GUTTER_GAP_CLASS` 또는 `*-my-16 lg:*-my-20`(가로) · `*-my-12 lg:*-my-20`(gap).
