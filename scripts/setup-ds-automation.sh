...
echo ""
echo "==> 4. DS 저장소 (Renovel-Studio-DS) — 수동 1회 설정"
echo "  a) docs/ds-repo-release-notify.yml → .github/workflows/notify-upnunde-test.yml 복사"
echo "  b) DS repo Secret: UPNUNDE_TEST_DISPATCH_PAT"
echo "     (upnunde-test repository_dispatch 권한 있는 fine-grained PAT)"
echo "  c) upnunde-test repo Secret (DS 비공개 시): DS_REPO_TOKEN"
echo ""
