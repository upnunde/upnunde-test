  ...
  return (
    <Dialog open={open} onOpenChange={handleDialogOpenChange}>
      <DialogContent className="flex w-full max-h-[90vh] min-h-0 max-lg:max-w-none flex-col gap-0 overflow-hidden rounded-[4px] border border-border-10 bg-white p-0 lg:max-w-2xl">
        <div className="border-b border-border-10/5 px-my-12 lg:px-my-20 py-my-12">
        ...
        {showSeriesFilter && (
          <div className="border-b border-border-10/5 px-my-12 lg:px-my-20 pb-my-12 pt-0">
            <div
              className={cn(
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-my-12 lg:px-my-20 py-my-16">
        ...
        <div className="flex items-center justify-end gap-my-8 border-t border-border-10/5 px-my-12 lg:px-my-20 py-my-12">
          <Button
            type="button"
            variant="outline"
