...
/** z-index: DS 6-tier 스택 (docs/design-system.md) */
export const MOBILE_BOTTOM_SHEET_SCRIM_Z_CLASS = "z-overlay";
export const MOBILE_BOTTOM_SHEET_PANEL_Z_CLASS = "z-modal";
export const DIALOG_OVERLAY_Z_CLASS = "z-overlay";
export const DIALOG_CONTENT_Z_CLASS = "z-modal";
export const TOAST_STACK_Z_CLASS = "z-toast";

/** radius-16 — 모바일 바텀 시트 상단 모서리 */
export const MOBILE_MODAL_TOP_RADIUS_CLASS = "rounded-t-xl";
...
export const MOBILE_MODAL_RADIUS_CLASS = "max-lg:rounded-xl";
...
/** 모바일 바텀 시트 스크림 — 기본 딤은 Scrim 20(`bg-dim-20`). 키보드 포함 현재 visual viewport를 덮어 딤 밀림 방지, 탭으로 닫기 */
export const MOBILE_BOTTOM_SHEET_SCRIM_CLASS = cn(
  "fixed inset-x-0 bottom-0 top-0 touch-none bg-dim-20",
...
export const MOBILE_BOTTOM_SHEET_SHELL_BASE_CLASS = cn(
  ...
  "flex min-h-0 flex-col border-t border-border bg-background shadow-elevation-40",
...
export const formDialogShellClassName = cn(
  ...
  "max-lg:h-[min(92dvh,900px)] max-lg:max-w-none max-lg:w-full max-lg:bg-background max-lg:shadow-elevation-50 max-lg:pb-0",
  MOBILE_MODAL_TOP_RADIUS_CLASS,
  MOBILE_BOTTOM_SHEET_BOTTOM_RADIUS_CLASS,
  "lg:h-auto lg:max-h-[min(90vh,calc(100dvh-80px))] lg:w-[min(92vw,760px)] lg:max-w-[760px] lg:gap-0 lg:overflow-hidden lg:p-0 lg:rounded-sm",
);

/** 바텀 시트 안 폼 본문 — EpisodeForm 등 */
export const formDialogSheetEpisodeFormClassName =
  "w-full mx-0 max-w-none min-w-0 flex-1 min-h-0 rounded-none border-0 bg-background shadow-none lg:rounded-sm lg:border lg:border-border";
...
export const modalFooterShellClassName = cn(
  "self-stretch overflow-hidden bg-background",
  MOBILE_BOTTOM_SHEET_BOTTOM_RADIUS_CLASS,
