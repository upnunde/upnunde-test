...
export const MOCK_NOTIFICATION_COUNT = 500;

/** 공지/작품알림 랜덤 더미 데이터 생성 */
export function buildMockNotifications(): NotificationData[] {
...
const WELCOME_EVENT_NOTIFICATION: NotificationData = {
  id: "event-welcome-coupon",
  category: "EVENT",
  title: "신규가입 회원 웰컴 쿠폰팩",
  content:
    "10% 더블쿠폰 + 전상품쿠폰! 신규 가입을 환영하며 웰컴 쿠폰팩을 드립니다. 전상품 15% 쿠폰과 TV쇼핑 10% 쿠폰을 마이페이지 > 쿠폰함에서 확인해 주세요. 쿠폰은 지급일로부터 30일 이내 사용할 수 있으며, 일부 유료 상품·프로모션 대상 제외 상품에는 적용되지 않을 수 있습니다.",
  date: "5분 전",
  isRead: false,
  bannerSrc: "/notifications/welcome-coupon-pack.png",
