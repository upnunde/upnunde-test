            ...
            <header className="flex h-16 shrink-0 items-center justify-center border-b border-slate-200 bg-white px-6 py-0">
              <div className="flex w-full max-w-[1200px] min-w-[800px] items-center justify-between gap-4">
                <div className="flex items-center justify-start gap-3">
                  ...
                  <h1 className="text-2xl font-extrabold text-slate-900">시리즈 만들기</h1>
                </div>
                ...
                <div className="flex-1 min-w-0">
                  <PageCard>
                    ...
                    <div className="w-full pt-0 pb-0 mt-0 mb-5 border-b border-slate-200 inline-flex flex-col justify-start items-start gap-2.5">
                      <div className="w-full inline-flex justify-start items-center gap-4 overflow-hidden">
                        {(
                          [
                            ["image", "이미지"],
                            ["info", "정보"],
                      ...
                      <div className="flex flex-col gap-10">
                        ...
                        <div className="flex flex-col gap-1">
                          <label className="flex items-center justify-start text-sm font-bold text-slate-900">
                            대표이미지<span className="text-red-500 px-1 h-fit w-fit align-middle -mt-1">*</span>
                          </label>
                          <p className="text-xs text-slate-400">
                            시리즈를 대표하는 공식 이미지입니다. 부적절한 이미지는 사용이 제한됩니다.
                          </p>
                          <label
                            ref={coverRef}
                          ...
                          >
                            {coverPreviewUrl ? (
                              ...
                              <div className="w-6 h-6 relative">
                                <div className="w-5 h-5 left-[2.25px] top-[2.25px] absolute flex items-center justify-center text-on-surface-10">
                        ...
                        <div className="flex flex-col gap-1">
                          <label className="flex items-center justify-start text-sm font-bold text-slate-900">
                            로고<span className="text-red-500 px-1 h-fit w-fit align-middle -mt-1">*</span>
                          </label>
                          <p className="text-xs text-slate-400">
                            배경이 투명한 png파일을 사용하세요.
                          </p>
                          <label
                            ref={logoRef}
                            htmlFor="series-logo"
                    ...
                    {activeTab === "info" && (
                      <div className="flex flex-col gap-10">
                        ...
                        <div className="flex flex-col gap-1">
                          <label className="flex items-center justify-start text-sm font-bold text-slate-900">
                            시리즈 제목<span className="text-red-500 px-1 h-fit w-fit align-middle -mt-1">*</span>
                          </label>
                          <p className="text-xs text-slate-400">
                            요약 내용이 AI 전개의 가이드라인이 된다는 기술적 사실을 전달합니다.
                          </p>
                          <input
                            ref={titleRef}
                            type="text"
                            ...
                            className={cn(
                              "mt-1 h-12 rounded-md border bg-white px-3 py-2 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 w-full",
                              fieldErrors.title
                        ...
                        <div className="flex flex-col gap-1">
                          <label className="flex items-center justify-start text-sm font-bold text-slate-900">
                            시리즈 요약<span className="text-red-500 px-1 h-fit w-fit align-middle -mt-1">*</span>
                          </label>
                          <p className="text-xs text-slate-400">
                            작품의 핵심 컨셉을 한 줄로 요약하여 독자의 흥미와 클릭을 유도하세요
                          </p>
                          <textarea
                            ref={summaryRef}
                            rows={3}
                            ...
                            className={cn(
                              "mt-1 resize-y rounded-md border bg-white px-3 py-2 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 w-full min-h-[80px]",
                              fieldErrors.summary
                                ? "border-destructive focus:ring-destructive/40"
                                : "border-slate-200 focus:ring-primary"
                            )}
                        ...
                        <div className="flex flex-col gap-1">
                          <label className="flex items-center justify-start text-sm font-bold text-slate-900">
                            키워드<span className="text-red-500 px-1 h-fit w-fit align-middle -mt-1">*</span>
                          </label>
                          <p className="text-xs text-slate-400">
                            세계관은 모든 에피소드의 배경과 논리를 구성하는 기준이 됩니다.
                          </p>
                          <input
                            ref={keywordsRef}
                            type="text"
                        ...
                        <div className="flex flex-col gap-1">
                          <label className="flex items-center justify-start text-sm font-bold text-slate-900">
                            세계관 설명<span className="text-red-500 px-1 h-fit w-fit align-middle -mt-1">*</span>
                          </label>
                          <p className="text-xs text-slate-400">
                            독자들이 작품의 배경과 규칙을 쉽고 깊이 있게 이해할 수 있도록 자유롭게 설명해 주세요.
                          </p>
                          <textarea
                            ref={worldviewRef}
                            rows={6}
                            ...
                            className={cn(
                              "mt-1 resize-y rounded-md border bg-white px-3 py-2 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 w-full min-h-[120px]",
                    ...
                    {activeTab === "worldview" && (
                      <div className="flex flex-col gap-10">
                        ...
                        <div className="flex flex-col gap-1">
                          <label className="flex items-center justify-start text-sm font-bold text-slate-900">
                            세계관 프롬프트<span className="text-red-500 px-1 h-fit w-fit align-middle -mt-1">*</span>
                          </label>
                          <p className="text-xs text-slate-400">
                            세계관은 모든 에피소드의 배경과 논리를 구성하는 절대적인 기준이 됩니다. 설정이 구체적일수록 AI가 원작의 의도에서 벗어나지 않고 일관성 있는 전개를 이어갈 수 있습니다.
                          </p>
                          <textarea
                            ref={promptRef}
                            rows={8}
                            ...
                            className={cn(
                              "mt-1 resize-y rounded-md border bg-white px-3 py-2 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 w-full min-h-[160px]",
                              fieldErrors.prompt
                                ? "border-destructive focus:ring-destructive/40"
                                : "border-slate-200 focus:ring-primary"
                            )}
                        ...
                        <div className="flex flex-col gap-1">
                          <label className="flex items-center justify-start text-sm font-bold text-slate-900">
                            페르소나<span className="text-red-500 px-1 h-fit w-fit align-middle -mt-1">*</span>
                          </label>
                          <p className="text-xs text-slate-400">
                            작품의 핵심 컨셉을 한 줄로 요약하여 독자의 흥미와 클릭을 유도하세요
                          </p>
