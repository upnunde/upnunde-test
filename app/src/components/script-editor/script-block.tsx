      ...
      <div className="flex w-full items-start gap-2">
        <Popover>
          <PopoverTrigger asChild>
            <button
              type="button"
              className="shrink-0 pt-2 text-caption1_500 text-muted-foreground hover:text-foreground"
            >
              {style.label}
            </button>
          </PopoverTrigger>
            ...
            <div className="flex flex-col gap-0.5">
              {ALL_BLOCK_TYPES.map((t) => (
                <button
                  ...
                  className={cn(
                    "rounded px-2 py-2 text-left text-body3_400",
                    block.type === t
        ...
        <div className="min-w-0 flex-1">
          {isEditable ? (
            ...
            <Input
              ...
              className="min-h-[1.5rem] w-full border-0 bg-transparent shadow-none focus-visible:ring-0"
            />
          )}
        </div>
      </div>
