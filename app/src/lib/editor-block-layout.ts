...
export const EDITOR_MOBILE_GUTTER_X_CLASS = "max-lg:px-2";
...
export const EDITOR_SCENE_VALUE_FIELD_CLASS =
  "min-h-8 h-fit min-w-0 w-full flex-1 resize-none overflow-hidden border-0 bg-transparent px-0 pt-1 pb-0 text-foreground outline-none placeholder:text-foreground-placeholder focus:outline-none focus:ring-0 whitespace-pre-wrap break-words [overflow-wrap:anywhere]";
...
export const EDITOR_SCENE_TITLE_DISPLAY_CLASS =
  "block w-full min-h-8 min-w-0 resize-none overflow-hidden border-0 bg-transparent px-0 py-0 editor-scene-title-typography text-foreground whitespace-pre-wrap break-words [overflow-wrap:anywhere]";

/** 장면 제목 입력 */
export const EDITOR_SCENE_TITLE_INPUT_CLASS =
  "block w-full min-h-8 min-w-0 resize-none overflow-hidden border-0 bg-transparent px-0 py-0 editor-scene-title-typography text-foreground placeholder:text-foreground-placeholder outline-none transition-colors focus:outline-none focus:ring-0 cursor-text whitespace-pre-wrap break-words [overflow-wrap:anywhere]";
