/** 분석·수익 `주요통계` 카드 행 — 카드 min 240px, 공간 부족 시 줄바꿈 */
...
export const ANALYTICS_KEY_STAT_BUTTON_CLASS =
  "min-w-[240px] flex-[1_1_240px] self-stretch border-b border-border-10 px-my-12 lg:px-my-20 py-my-40 inline-flex flex-col items-center justify-start gap-my-4";
